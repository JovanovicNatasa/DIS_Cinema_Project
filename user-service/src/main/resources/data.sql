...
VALUES (1, 1, 'Admin', 'admin@cinema.com', '$2a$10$N.zmdr9k8mgh.LuMRjCOmuLpnZaQpNe4MauvKEV3XMiJ0o/Vm6UaK')
ON CONFLICT (id) DO NOTHING;

INSERT INTO users (id, role_id, first_name, email, password)
VALUES (2, 2, 'Natasa', 'natasa@cinema.com', '$2a$10$N.zmdr9k8mgh.LuMRjCOmuLpnZaQpNe4MauvKEV3XMiJ0o/Vm6UaK')
ON CONFLICT (id) DO NOTHING;

INSERT INTO users (id, role_id, first_name, email, password)
VALUES (3, 2, 'Marko', 'marko@cinema.com', '$2a$10$N.zmdr9k8mgh.LuMRjCOmuLpnZaQpNe4MauvKEV3XMiJ0o/Vm6UaK')
ON CONFLICT (id) DO NOTHING;
